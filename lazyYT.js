/*! LazyYT (lazy load Youtube videos plugin) - v0.1.3 - 2013-09-24
...
;(function ($) {
    ...
    var setUp = function (el) {
        ...
        if (typeof width === 'undefined' || typeof width === 'undefined' || typeof id === 'undefined') {
